const employees = [
    ...
    {name: 'Donna Paulsen', department: 'Assistance', email: 'donna@paulsen.us'},
    {name: 'Jessica Pearson', department: 'Management', email: 'jessica@pearson.us'},
    {name: 'Katrina Bennett', department: 'Law', email: 'katrina@bennett.us'},
    {name: 'Daniel Hardman', department: 'Management', email: 'daniel@hardman.us'},
    ...
    {name: 'Jenny Griffith', department: 'Consultation', email: 'jenny@griffith.us'},
];
