...
var countDownDate = new Date("Dec 06, 2019 05:30 pm").getTime();
...
var now = new Date().getTime();
 ...
 document.getElementById("afaan").innerHTML = days + "d : " + hours + "h : "
 + minutes + "m : " + seconds + "s ";

 // If the count down is over, write some text
if (distance < 0) {
   clearInterval(x);
 document.getElementById("afaan").innerHTML = "EXPIRED";
}
}, 1000);
...
//documention :
autoTyping({
container : document.querySelector('.of-barresa'),
text : ["Welcome",
    "Willkommen",
    "Bienvenue",
    "أهلا بك",
...
typeSpeed : 150,
loopSpeed : 500,
    color: ['#fff', '#C13584', '#008080', '#FCAF45', '#E1306C', '#5851DB','#006400	'],//optional
blink : false, //optional
blinkSpeed : 400,
